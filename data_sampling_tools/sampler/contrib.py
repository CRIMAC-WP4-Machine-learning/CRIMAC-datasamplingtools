from .base import BaseRandomSampler, BaseGriddedSampler
from ..core.sampler import SamplerItem
from ..core.cruise import ICruiseList
from ..cruise import CruiseListBase
...
class GriddedSchoolSampler(BaseGriddedSampler):
    ...
    # TODO: enlarge box similar to random sampler
    @staticmethod
        ...
        for cruise in cruise_list.cruises:
            for category in cruise.categories:
                for box in cruise.school_boxes[category]:
                    new_cruises.append(cruise.from_box(*box, category=category))
